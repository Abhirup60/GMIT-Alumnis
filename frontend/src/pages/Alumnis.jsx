...
const AdminUsers = () => {
  ...
  const handleApprove = async (userId) => {
    ...
    try {
      const response = await fetch(`https://gmit-alumnis-backend.onrender.com/api/auth/admin/approve-user/${userId}`, {
        method: "PUT",
        headers: {
  ...
  const handleReject = async (id) => {
    ...
    try {
      console.log(id);
      const response = await fetch(`https://gmit-alumnis-backend.onrender.com/api/auth/admin/delete-user/${id}`, {
        method: "DELETE",
      });
                ...
                filteredAlumni.map((user, index) => (
                  <tr key={index} className='border-b border-gray-200 hover:bg-gray-50 transition'>
                    ...
                    <td className='py-4 px-4 text-center'>
                      <a
                        href={`https://gmit-alumnis-backend.onrender.com/files/${user.file}`}
                        target='_blank'
